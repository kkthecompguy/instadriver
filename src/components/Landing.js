          ...
          <div className='card card-body'>
            <div className='inbox active-inbox'>
              <div className='user-info'>
                <img
                  src='https://images.unsplash.com/photo-1602524817552-1afd1d923ace?ixid=MXwxMjA3fDF8MHxlZGl0b3JpYWwtZmVlZHwxN3x8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=60'
                  alt='Image1'
                  className='avatar'
                />
          ...
          <div className='message-box'>
            ...
            <div className='messages'>
              <div className='message-incoming'>
                <div className='message'>
                  <p>
                    ...
                    Odit numquam porro ea vero a nihil ipsa dolor nesciunt unde
                    voluptatem!
                  </p>
                </div>
                <span>11.00 am </span>
              ...
              <div className='message-outgoing'>
                ...
                <span className='delivered'>
                  11.30 am <i className='fas fa-check-double'></i>
                </span>
              </div>
              <div className='message-incoming'>
                <div className='message'>
              ...
              <div className='message-outgoing'>
                ...
                <span>
                  11.40 am <i className='fas fa-check-double'></i>
                </span>
              </div>
              <div className='message-outgoing'>
                <div className='message'>
                ...
                <span>
                  12.50 pm <i className='fas fa-check'></i>
                </span>
              </div>
            </div>
            ...
            <div className='contact-info' id='contact-info'>
              <div className='contact-header'>
                <span>
                  <i className='fas fa-info'></i>Contact
                </span>
              </div>
